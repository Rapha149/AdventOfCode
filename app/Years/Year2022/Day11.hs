module Years.Year2022.Day11 (part1, part2) where
...
getMonkeyBusiness rounds relief = (\(a:b:_) -> a * b) . sortOn Down . Map.elems . uncurry (getInspectionCounts rounds relief)
